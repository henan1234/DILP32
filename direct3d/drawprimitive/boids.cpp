...
// ground pattern
D3DVECTOR       grid_color(0.5f, 0.3f, 0.0f);
...
Drawboid(LPDIRECT3DDEVICE2 lpDev)
{
	...
	// Notice how easy it is to render a primitive!
...
HRESULT D3DScene::Render(void)
{
	...
	///////////////////////////////////////////////////////////////////////////
	// This is the start of the boid rendering. Notice that we're doing three
	// things here.
	// 1) Setting up any state changes needed by the boids
	// 2) Using the World transform to change where each boid is rendered
	//    (It's the same vertex list for each boid, just a different color
	//     and location)
	// 3) rendering the primitive
	////////////////////////////////////////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////
	// Creating a new view matrix since the viewpoint changes with each frame
	// There's no point in recreating the view matrix however....
	////////////////////////////////////////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////
	// This command just updates the position and orientation of each boid
	////////////////////////////////////////////////////////////////////////////
	...
	///////////////////////////////////////////////////////////////////////////
	// Now, start the rendering. Notice that there's a hell of a lot of matrix math
	// going on here, and this'd be a good spot for some optimization I think.
	////////////////////////////////////////////////////////////////////////////
	...
	for (i=0; i<flock.num_boids; i++) {
		...
		///////////////////////////////////////////////////////////////////////////
		// Here we're setting up the boids position
		///////////////////////////////////////////////////////////////////////////
		...
		///////////////////////////////////////////////////////////////////////////
		// And setting the boids color (material, to be correct)
		///////////////////////////////////////////////////////////////////////////
		...
		///////////////////////////////////////////////////////////////////////////
		// And finally, once everything is set up, we call the routine
		// to render the boid primitive
		///////////////////////////////////////////////////////////////////////////
	...
	// Notice these state changes to render transparent objects.
	// Notice the particular settings required. These are key to understanding
	// how to render transparent objects. Notice that we're rendering the
