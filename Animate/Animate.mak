...
ALL : "$(OUTDIR)\Animate.exe"

CLEAN : 
	-@erase "$(INTDIR)\Animate.obj"
	-@erase "$(INTDIR)\Animate.pch"
	-@erase "$(INTDIR)\Animate.res"
	-@erase "$(INTDIR)\AnimateDlg.obj"
	-@erase "$(INTDIR)\StdAfx.obj"
	-@erase "$(OUTDIR)\Animate.exe"
...
"$(OUTDIR)\Animate.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\Animate.exe"
	-@erase "$(OUTDIR)\Animate.ilk"
	-@erase "$(OUTDIR)\Animate.pdb"
...
"$(INTDIR)\AnimateDlg.obj" : $(SOURCE) $(DEP_CPP_ANIMAT) "$(INTDIR)"\
 "$(INTDIR)\Animate.pch"
...
"$(INTDIR)\Animate.pch" : $(SOURCE) $(DEP_CPP_STDAF) "$(INTDIR)"
   $(BuildCmds)
...
"$(INTDIR)\Animate.res" : $(SOURCE) $(DEP_RSC_ANIMATE) "$(INTDIR)"
   $(RSC) $(RSC_PROJ) $(SOURCE)
