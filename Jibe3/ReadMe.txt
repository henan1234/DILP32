========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : Jibe3
========================================================================


AppWizard has created this Jibe3 application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your Jibe3 application.

Jibe3.h
    This is the main header file for the application.  It includes other
    project specific headers (including Resource.h) and declares the
    CJibe3App application class.
...
res\Jibe3.ico
    ...
    icon is included by the main resource file Jibe3.rc.
...
Jibe3Dlg.h, Jibe3Dlg.cpp - the dialog
    These files contain your CJibe3Dlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in Jibe3.rc, which can be edited in Microsoft
	Developer Studio.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CJibe3DlgAutoProxy class.  This class
...
MakeHelp.bat
    Use this batch file to create your application's Help file, hlp\Jibe3.hLP.
...
StdAfx.h, StdAfx.cpp
    ...
    named Jibe3.pch and a precompiled types file named StdAfx.obj.
