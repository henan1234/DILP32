///////////////////////////////////////////////////////////////////////////////
// DIBSURFACE.H
// Interface de la classe CDibSurface
///////////////////////////////////////////////////////////////////////////////
#ifndef _DIBSURFACE_H_
#define _DIBSURFACE_H_
...
public:
    ...
    void BitBlt(CDC* pDC, int xd, int yd, int w, int h, int xs, int ys);  
    void BitBlt(HDC hDC, int xd, int yd, int w, int h, int xs, int ys);  
    void StretchBlt(CDC* pDC, int xd, int yd, int wd, int hd, int xs, int ys, int ws, int hs);  
    void Draw(CDC* pDC);
