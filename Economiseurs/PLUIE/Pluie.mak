...
!IF "$(CFG)" == ""
CFG=Pluie - Win32 Debug
!MESSAGE No configuration specified.  Defaulting to Pluie - Win32 Debug.
!ENDIF 

!IF "$(CFG)" != "Pluie - Win32 Release" && "$(CFG)" != "Pluie - Win32 Debug"
!MESSAGE Invalid configuration "$(CFG)" specified.
!MESSAGE You can specify a configuration when running NMAKE on this makefile
!MESSAGE by defining the macro CFG on the command line.  For example:
!MESSAGE 
!MESSAGE NMAKE /f "Pluie.mak" CFG="Pluie - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "Pluie - Win32 Release" (based on "Win32 (x86) Application")
!MESSAGE "Pluie - Win32 Debug" (based on "Win32 (x86) Application")
!MESSAGE 
...
ALL : "$(OUTDIR)\Pluie.exe"

CLEAN : 
	-@erase ".\Release\Pluie.exe"
...
CPP_PROJ=/nologo /ML /W3 /GX /O2 /D "WIN32" /D "NDEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/Pluie.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\Release/
CPP_SBRS=
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/Pluie.bsc" 
BSC32_SBRS=
LINK32=link.exe
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 ...
 /incremental:no /pdb:"$(OUTDIR)/Pluie.pdb" /machine:I386\
 /out:"$(OUTDIR)/Pluie.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Specif.obj" \
	"$(INTDIR)/Econo.obj" \
	"$(INTDIR)/Econo.res"

"$(OUTDIR)\Pluie.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
  $(LINK32_FLAGS) $(LINK32_OBJS)
<<

!ELSEIF  "$(CFG)" == "Pluie - Win32 Debug"
...
CPP_PROJ=/nologo /MLd /W3 /Gm /GX /Zi /Od /D "WIN32" /D "_DEBUG" /D "_WINDOWS"\
 /Fp"$(INTDIR)/Pluie.pch" /YX /Fo"$(INTDIR)/" /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\Debug/
CPP_SBRS=
...
LINK32_FLAGS=kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib\
 advapi32.lib shell32.lib scrnsave.lib comctl32.lib /nologo /subsystem:windows\
 /incremental:yes /pdb:"$(OUTDIR)/Pluie.pdb" /debug /machine:I386\
 /out:"$(OUTDIR)/Pluie.exe" 
LINK32_OBJS= \
	"$(INTDIR)/Specif.obj" \
	"$(INTDIR)/Econo.obj" \
...
# Name "Pluie - Win32 Release"
# Name "Pluie - Win32 Debug"
