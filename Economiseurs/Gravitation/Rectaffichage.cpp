...
///////////////////////////////////////////////////////////////////////
void CRectAffichage::BitBlt( HDC hDcDest, HDC hDcSrc, DWORD	RasterOp ) const
	{
...
void CRectAffichage::PatBlt( HDC hDcDest, DWORD	RasterOp  ) const
	{
	const	BOOL	Limite	=	! _Espace.IsRectEmpty() ;
...
void CRectAffichage::FillRect( HDC hDcDest, COLORREF Couleur ) const
	{
