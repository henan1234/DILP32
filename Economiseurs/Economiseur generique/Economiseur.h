...
class	CEconomiseur
	...
	public :
		...
		const CString & NomEconomiseur() const { return _Nom ; } ;
...
protected:
	...
	static void LitFichier( const char * pFileName, UINT IdStrSection, const TCHAR *, double & Value );
	static void LitFichier( const char * pFileName, UINT IdStrSection, const TCHAR * ValueName, CString & Value );
	static void LitFichier( const char * pFileName, UINT IdStrSection, UINT IdsValueName, CString & Value );
	HPALETTE hPalette ;
